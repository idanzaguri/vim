...
syn keyword veraStatement	extern for fork foreach
...
syn keyword veraStatement	public rand randc srandom
...
syn keyword veraStatement       sample sample_event cross
syn keyword veraStatement       cross_auto_bin_max cross_num_print_missing
syn keyword veraStatement       fatal error warn info debug 
...
syn keyword veraRepeat          repeat while for foreach 
...
syn keyword veraTask            coverage_group
" syn keyword veraTask		delay error error_mode
syn keyword veraTask		delay error_mode
