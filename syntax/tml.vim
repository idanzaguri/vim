...
syn keyword verilogStatement   PNM_FUNC NOTIFY FIFO_SIZE PRINT EX CALL RD WR WAIT 
syn keyword verilogStatement   PTMVAR EVENT INT NOTIFY PUSH POP TOP
...
syn keyword verilogConditional IF THEN ELSE ELSIF END
syn keyword verilogRepeat      REPEAT WHILE DO RQ 
