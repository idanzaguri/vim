...
syn keyword libLabel           assert property endproperty return
syn keyword libLabel           covergroup endgroup new coverpoint sample cross
...
syn keyword verilogStatement   logic
syn keyword verilogLabel       begin end fork join
syn keyword verilogConditional if else case casex casez default endcase sequence endsequence
syn keyword verilogStatement   iff
syn keyword verilogRepeat      forever repeat while for

syn keyword verilogTodo contained TODO

syn match   verilogOperator "[&|~><!)(*#%@+/=?:;}{,.\^\-\[\]]"
syn match   verilogLabel    "|->"
