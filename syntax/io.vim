...
syntax keyword xKeyword ifNil ifTrue isActive isNil isResumable list message
syntax keyword xKeyword method or parent pass pause perform
syntax keyword xKeyword performWithArgList print proto raise raiseResumable
