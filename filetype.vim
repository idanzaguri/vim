...
" Specman
au BufNewFile,BufRead *.e,*.E		setf specman 

" Eiffel or Specman
"IZ au BufNewFile,BufRead *.e,*.E			call FTCheck_e()
"IZ 
"IZ fun! FTCheck_e()
"IZ   let n = 1
"IZ   while n < 100 && n < line("$")
"IZ     if getline(n) =~ "^\\s*\\(<'\\|'>\\)\\s*$"
"IZ       set ft=specman
"IZ       return
"IZ     endif
...
" PANAMA (also: *.tml)
au BufNewFile,BufRead *.tml		setf tml
...
" Verilog HDL
" au BufNewFile,BufRead *.v,*.vpp,*.V		setf verilog
" System Verilog HDL
" au BufNewFile,BufRead *.sv,*.sva,*.svh		setf verilog_systemverilog
"au BufNewFile,BufRead *.v,*.vpp,*.V,*.sv,*.sva,*.svh		setf systemverilog
"au! BufRead,BufNewFile *.v,*.vh,*.sv,*.svh setfiletype verilog_systemverilog

"autocmd BufRead,BufNewFile *.v,*.vh,*.sv,*.svh,*.vlog   set filetype=uvm_sv
autocmd BufRead,BufNewFile *.v,*.vh,*.sv,*.svh,*.vlog   set filetype=systemverilog

autocmd BufRead,BufNewFile run.log  set filetype=qbar_log
autocmd BufRead,BufNewFile pcie.trans set filetype=pcie_trans
...
au BufNewFile,BufRead,StdinReadPost *
	\ if !did_filetype() | runtime! ~/.vim/syntax/scripts.vim | endif
